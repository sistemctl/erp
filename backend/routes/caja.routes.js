...
router.post('/apertura', authMiddleware, rolesMiddleware(['admin', 'superadmin', 'gerente_sede', 'cajero']), cajaController.aperturaCaja);
router.post('/cierre', authMiddleware, rolesMiddleware(['admin', 'superadmin', 'gerente_sede', 'cajero']), cajaController.cierreCaja);
router.post('/liberar', authMiddleware, rolesMiddleware(['admin', 'superadmin']), cajaController.liberarCaja);
