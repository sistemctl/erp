/**
 * IVA por ítem según producto.tieneIVA (precios con IVA incluido).
 */
...
export function calcCotIvaItems(items, ivaPct = 19) {
...
export function etiquetaIvaCot(iva, ivaPct = 19) {
